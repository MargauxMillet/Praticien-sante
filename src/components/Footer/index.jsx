        ...
        <div className="infos">
            <div className="rs">
                <Link to="https://www.instagram.com/michelcanonico.reflexo.sophro/" target="_blank" rel="noopener noreferrer">
                    <svg className="insta-icon" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link to="https://www.facebook.com/p/Michel-Canonicosophrologue-réflexologue-100064109441980" target="_blank" rel="noopener noreferrer">
                    <svg className="fb-icon" width="14" height="26" viewBox="0 0 14 26" fill="none" xmlns="http://www.w3.org/2000/svg">
