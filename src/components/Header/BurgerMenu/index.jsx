...
function BurgerMenu() {
    ...
    return (
        <div style={{right: burgerMenuRight}} className={style.burgerMenu}>
            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" className={style.back} onClick={()=>setBurgerMenuOpen(false)}>
